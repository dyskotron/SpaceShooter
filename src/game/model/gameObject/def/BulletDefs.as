        ...
        public function getBulletVO(aBulletType: uint): BulletVO
        {
            switch (aBulletType)
            {
                case BulletID.LASER_1:
                    return new BulletVO(aBulletType, BulletMode.ONE_SHOT, BulletAim.NONE, 0, 15, 4, 4, LASER_DMG_TO_COST);
                    break;
                ...
                case BulletID.PLASMA_1:
                    return new BulletVO(aBulletType, BulletMode.EACH_ONCE, BulletAim.NONE, 0, 8, 4, 4, PLASMA_DMG_TO_COST);
                    break;
                case BulletID.PLASMA_2:
                    return new BulletVO(aBulletType, BulletMode.EACH_ONCE, BulletAim.NONE, 0, 8, 4, 4, PLASMA_DMG_TO_COST);
                    break;
                case BulletID.PLASMA_3:
                    return new BulletVO(aBulletType, BulletMode.EACH_ONCE, BulletAim.NONE, 0, 15, 6, 4, PLASMA_DMG_TO_COST);
                    break;
                case BulletID.PLASMA_4:
                    return new BulletVO(aBulletType, BulletMode.EACH_ONCE, BulletAim.NONE, 0, 30, 8, 4, PLASMA_DMG_TO_COST);
                    break;

                case BulletID.ELECTRIC_1:
                    return new BulletVO(aBulletType, BulletMode.ONE_SHOT, BulletAim.NONE, 0, 10, 4, 4, ELECTRIC_DMG_TO_COST);
                    break;
                case BulletID.ELECTRIC_2:
                    return new BulletVO(aBulletType, BulletMode.ONE_SHOT, BulletAim.NONE, 0, 20, 4, 4, ELECTRIC_DMG_TO_COST);
                    break;

                case BulletID.ROCKET_1:
                    return new BulletVO(aBulletType, BulletMode.AOE, BulletAim.ON_UPDATE, TargetType.EASIEST, 150, 50, 80, AOE_DMG_TO_COST, 200);
                    break;
