package game.model.gameObject.def
{
    ...
    public class BehaviorDefs implements IBehaviorDefs
    {
        ...
        public function BehaviorDefs()
        {

        }

        public function getBehaviorVO(aBehaviorID: uint): BehaviorVO
        {
            ...
            switch (aBehaviorID)
            {
                case FLY_THROUGH:
                    ...
                    break;
                case GET_TO_POS:
                    behaviourVO.addState(new GetToPosState());
                    behaviourVO.addState(new StopState());
                    break;
                case GET_TO_X:
                    behaviourVO.addState(new GetToXposState());
                    behaviourVO.addState(new StopState());
                    break;
                case GET_TO_Y:
                    behaviourVO.addState(new GetToYposState());
                    behaviourVO.addState(new StopState());
                    break;
                case KAMIKAZE_STARIGHT:
                    behaviourVO.addState(new GetToYposState(new Target(0, 300)));
